        ...
        <div className="text-center">
          ...
          <div className="mt-20 flex justify-center items-center space-x-8 rtl:space-x-reverse">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-400">{t('nav.students')}</span>
            </div>
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-400">{t('nav.teachers')}</span>
            </div>
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-gray-400">{t('nav.courses')}</span>
            </div>
          </div>
        </div>
      </div>
