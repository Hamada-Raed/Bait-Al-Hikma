...
const Footer: React.FC = () => {
  const { t, platformName, platformLogoUrl } = useLanguage();
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 rtl:space-x-reverse">
              <a href="#" className="w-10 h-10 bg-dark-200 rounded-lg flex items-center justify-center text-gray-400 hover:text-primary-400 hover:bg-dark-300 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#courses" className="text-gray-400 hover:text-primary-400 transition-colors">
                  {t('nav.courses')}
                </a>
              </li>
              <li>
                <a href="#teachers" className="text-gray-400 hover:text-primary-400 transition-colors">
                  {t('nav.teachers')}
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Email: info@dar-al-ill.com</li>
