...
type TabType = 'matching' | 'all' | 'enrolled' | 'in_progress' | 'completed' | 'teachers' | 'exams' | 'todo' | 'timer' | 'booked' | 'sessions-completed' | 'calendar' | 'whiteboard';
...
const StudentDashboard: React.FC<StudentDashboardProps> = ({ user }) => {
  ...
  // Sidebar state
  const [activeSidebarSection, setActiveSidebarSection] = useState<'courses' | 'sessions' | 'manage-time'>('courses');
  const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(['courses']));
  ...
  // Sidebar handlers
  const handleSectionChange = (section: 'courses' | 'sessions' | 'manage-time') => {
          ...
          <div className="bg-dark-100 rounded-xl p-6 border border-dark-300">
            ...
            <div className="flex border-b border-dark-300 mb-6">
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'matching'
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'teachers'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'exams'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'enrolled'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'in_progress'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'completed'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'todo'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 font-medium text-sm transition-colors ${activeTab === 'timer'
                  ? 'text-primary-400 border-b-2 border-primary-400'
                  : 'text-gray-400 hover:text-gray-300'
                  }`}
              >
                      ...
                      {selectedTodoList.items && selectedTodoList.items.length > 0 ? (
                        selectedTodoList.items
                          ...
                          .map((item: any) => (
                            <li
                              key={item.id}
                              className={`flex items-center gap-4 p-5 rounded-lg border list-none ${item.is_completed
                            ...
                            >
                              ...
                              {editingItems.has(item.id) ? (
                                ...
                                <>
                                  <span
                                    className={`flex-1 text-base text-gray-300 ${item.is_completed ? 'line-through decoration-2 text-gray-500' : ''
                                      }`}
                                  >
                                    {item.text}
                                  </span>
              ...
              <div className="py-6">
                {loadingTimers ? (
                  ...
                  <div className="max-w-2xl mx-auto bg-dark-100 rounded-xl p-8 border border-dark-300">
                    ...
                    {/* Timer Display */}
                    <div className="text-center mb-8">
                      <div className={`text-7xl font-mono font-bold mb-4 ${timeRemaining <= 60 && timeRemaining > 0
                      ...
                      <div className="max-w-md mx-auto mb-6">
                        <div className="w-full bg-dark-300 rounded-full h-3">
                          <div
                            className={`h-3 rounded-full transition-all duration-1000 ${isBreakTime
                              ? 'bg-green-500'
                      ...
                      >
                        ...
                        <div className="p-5">
                          ...
                          {teacher.bio && (
                            <div className="mb-4">
                              <p
                                className={`text-gray-400 text-sm ${shouldShowReadMore && !isBioExpanded ? 'line-clamp-2' : ''
                                  }`}
                              >
                                {teacher.bio}
                              </p>
